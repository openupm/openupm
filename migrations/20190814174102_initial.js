  ...
  return knex.schema
    ...
    .createTable("user", function(table) {
      ...
      table
        ...
        .defaultTo("");
      table
        .specificType("github_username", "CITEXT")
        .notNullable()
        .defaultTo("");
    ...
    .createTable("project", function(table) {
      ...
      table
        ...
        .defaultTo("");
      table
        .specificType("owner_avatar_url", "CITEXT")
        .notNullable()
        .defaultTo("");
      table
        .text("description")
        ...
        .defaultTo("");
      table
        .specificType("og_image_url", "CITEXT")
        .notNullable()
        .defaultTo("");
      table
        .boolean("use_og_image")
        .notNullable()
        .defaultTo(false);
      table
        .boolean("is_archived")
